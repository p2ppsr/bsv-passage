...
The unit suite covers BIP-39 and Electrum vectors, path integrity, independent indexer agreement, gap-limit behavior, replay and confirmation gates, selection tampering, input ceilings, source persistence bans, and CSP presence. CI also builds a checksum-addressed offline artifact and deploys only after all gates pass.
...
3. Both receiving and change chains are scanned to the configured gap.
